...
public final class ActivityMainSkipBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityMainSkipBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnFilter,
      @NonNull Button btnLogin, @NonNull ConstraintLayout constraintLayout,
      @NonNull EditText editTextTextPersonName, @NonNull EditText editTextTextPersonName2,
      @NonNull EditText editTextTextPersonName3, @NonNull RecyclerView rvFrequency,
  ...
  @NonNull
  public static ActivityMainSkipBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMainSkipBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_main_skip, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMainSkipBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainSkipBinding((ConstraintLayout) rootView, btnFilter, btnLogin,
          constraintLayout, editTextTextPersonName, editTextTextPersonName2,
          editTextTextPersonName3, rvFrequency, textView, textView1, textView2, textView3,
          textView4);
    }
