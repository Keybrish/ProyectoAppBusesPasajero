...
public final class ActivityWelcomeBinding implements ViewBinding {
  ...
  private ActivityWelcomeBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull Button btnRegister, @NonNull CardView btnSkip, @NonNull CardView cardView1,
  ...
  public static ActivityWelcomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btnSkip;
      CardView btnSkip = ViewBindings.findChildViewById(rootView, id);
      if (btnSkip == null) {
        break missingId;
      }
      ...
      return new ActivityWelcomeBinding((ConstraintLayout) rootView, btnLogin, btnRegister, btnSkip,
          cardView1, constraintLayout, imageView, imgProfile, textView, textView1, textView2,
          textView3, textView4, textView6, view);
    }
