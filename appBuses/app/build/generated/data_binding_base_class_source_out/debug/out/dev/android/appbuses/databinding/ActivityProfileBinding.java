...
public final class ActivityProfileBinding implements ViewBinding {
  ...
  private ActivityProfileBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnBack,
      ...
      @NonNull ImageView btnEditInfo, @NonNull ImageView btnHistory, @NonNull Button btnLogout,
      @NonNull CardView btnProfile, @NonNull CardView btnProfile1, @NonNull CardView btnProfile2,
      @NonNull CardView btnProfile3, @NonNull ConstraintLayout constraintLayout4,
      @NonNull ImageView imageView8, @NonNull ImageView imgProfile, @NonNull TextView textView10,
  ...
  public static ActivityProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProfileBinding((ConstraintLayout) rootView, btnBack, btnCamera,
          btnChangePassword, btnEditInfo, btnHistory, btnLogout, btnProfile, btnProfile1,
          btnProfile2, btnProfile3, constraintLayout4, imageView8, imgProfile, textView10,
