...
public final class ActivityFileBinding implements ViewBinding {
  ...
  private ActivityFileBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnBack,
      @NonNull Button btnNext, @NonNull CardView btnProfile, @NonNull ImageView btnUpload,
      @NonNull ConstraintLayout constraintLayout, @NonNull ImageView imageView3,
      @NonNull ImageView imgProfile, @NonNull TextView textView, @NonNull TextView textView1,
      @NonNull TextView textView2, @NonNull TextView textView22, @NonNull TextView textView3,
      @NonNull TextView textView30, @NonNull TextView txtFile, @NonNull View view2,
      @NonNull View view7) {
  ...
  public static ActivityFileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.txtFile;
      TextView txtFile = ViewBindings.findChildViewById(rootView, id);
      if (txtFile == null) {
        break missingId;
      }
      ...
      return new ActivityFileBinding((ConstraintLayout) rootView, btnBack, btnNext, btnProfile,
          btnUpload, constraintLayout, imageView3, imgProfile, textView, textView1, textView2,
          textView22, textView3, textView30, txtFile, view2, view7);
    }
