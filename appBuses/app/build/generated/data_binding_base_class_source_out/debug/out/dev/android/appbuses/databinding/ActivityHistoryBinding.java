...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView btnBack,
      @NonNull RecyclerView rvHistory, @NonNull TextView textView30) {
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityHistoryBinding((ConstraintLayout) rootView, btnBack, rvHistory,
          textView30);
    }
